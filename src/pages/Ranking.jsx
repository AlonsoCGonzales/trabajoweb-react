...
const Ranking = () => {
  return <div>
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-1" style={{ height: "40px" }}>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <a className="dropdown-item" href="img/rickroll.gif">Dale Click te daremos un turron</a>
                  </li>
                  <li>
                    <hr className="dropdown-divider"></hr>
                  </li>
                  <li>
                    <a className="dropdown-item" href="#">Unete a la legion</a>
                  </li>
                </ul>
              </li>
            </ul>
    ...
    <div class="container text-center">
      <div class="row">
        <div class="col">
          <h5>Tarjeta De Video Asus Tuf Gaming Oc gtx1650 4gb Gddr6</h5>
          <div class="progress">
      ...
      <div class="row">
        <div class="col">
          <h5>Gabinete Pc Gamer Cooler Master H500 Argb Templado Midtower</h5>
          <div class="progress">
        ...
        <div class="row">
          <div class="col">
            <h5>Memoria Ram 8gb 2600mhz Laptop Kingston</h5>
            <div class="progress">
